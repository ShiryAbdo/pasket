...
// final perofilmodelReducer = combineReducers<PerofilModelState>([
//   TypedReducer<PerofilModelState, PerofilModelStatusAction>(_perofilmodelStatus),
//   TypedReducer<PerofilModelState, SyncPerofilModelsAction>(_syncPerofilModels),
//   TypedReducer<PerofilModelState, SyncPerofilModelAction>(_syncPerofilModel),
//   TypedReducer<PerofilModelState, RemovePerofilModelAction>(_removePerofilModel),
// ]);

// PerofilModelState _perofilmodelStatus(PerofilModelState state, PerofilModelStatusAction action) {
...
// PerofilModelState _syncPerofilModels(PerofilModelState state, SyncPerofilModelsAction action) {
//   for (var perofilmodel in action.perofilmodels) {
//     state.perofilmodels.update(perofilmodel.FreeMarker template error (DEBUG mode; use RETHROW in production!):
