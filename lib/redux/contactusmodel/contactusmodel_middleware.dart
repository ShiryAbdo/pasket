...
// import 'package:plstka_app/data/remote/contactusmodel_repository.dart';
// import 'package:plstka_app/redux/contactusmodel/contactusmodel_actions.dart';
// import 'package:plstka_app/data/model/page_data.dart';

// List<Middleware<AppState>> createContactUsModelMiddleware([
//   ContactUsModelRepository _repository = const ContactUsModelRepository(),
// ]) {
//   final getContactUsModel = _createGetContactUsModel(_repository);
//   final getContactUsModels = _createGetContactUsModels(_repository);
//   final createContactUsModel = _createCreateContactUsModel(_repository);
//   final updateContactUsModel = _createUpdateContactUsModel(_repository);
//   final deleteContactUsModel = _createDeleteContactUsModel(_repository);

//   return [
//     TypedMiddleware<AppState, GetContactUsModelAction>(getContactUsModel),
//     TypedMiddleware<AppState, GetContactUsModelsAction>(getContactUsModels),
//     TypedMiddleware<AppState, CreateContactUsModelAction>(createContactUsModel),
//     TypedMiddleware<AppState, UpdateContactUsModelAction>(updateContactUsModel),
//     TypedMiddleware<AppState, DeleteContactUsModelAction>(deleteContactUsModel),
//   ];
// }

// Middleware<AppState> _createGetContactUsModel(
//     ContactUsModelRepository repository) {
